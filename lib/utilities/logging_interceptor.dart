...
/// It's better to add [LoggingInterceptor] to the tail of
/// the interceptor queue, otherwise the changes made in the interceptor
...
class LoggingInterceptor extends Interceptor {
  ...
  bool _canFlattenMap(Map map) =>
      map.values.where((val) => val is Map || val is List).isEmpty &&
